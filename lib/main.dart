...
import 'package:practica_lista_navegacion/view/details_view.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: TodoListScreen(tasks: tasks), // Pasar la lista de tareas a la pantalla de lista de tareas
    );
  }
}
...
class TodoListScreen extends StatelessWidget {
  const TodoListScreen({super.key, required this.tasks}); // Constructor de la pantalla de lista de tareas
