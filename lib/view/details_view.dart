...
import 'package:practica_lista_navegacion/model/task.dart'; // Importar el modelo de tarea

// Definición de la pantalla de detalles
class DetailsScreen extends StatelessWidget {
  const DetailsScreen({super.key, required this.task}); // Constructor de la pantalla de detalles
